...
func (bot *Bot) initCommands() {
	commands := []Command{
		{
			Translation: Translation{
				RussianName:        "`help (moderation) (gif) (nsfw)`",
				RussianDescription: "Список команд бота",
				EnglishName:        "`help (moderation) (gif) (nsfw)`",
		...
		{
			Translation: Translation{
				RussianName:        "`prefix <новый префикс>",
				RussianDescription: "Меняет префикс бота на этом сервере",
				EnglishName:        "`prefix <new prefix>",
				EnglishDescription: "Change bot prefix on this server",
			},
			Command:     "prefix ",
			Category:    moderationCategory,
			Permissions: 8,
